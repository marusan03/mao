...
### Phase 0: 📚 コンテキスト理解（必須）
**⚠️ コードレビューを開始する前に必ず実行してください**

1. **ドキュメントを読む**
   - プロジェクトREADME（プロジェクト概要、目的）
   - ARCHITECTURE.md（アーキテクチャ、設計方針）
   - CONTRIBUTING.md（コーディング規約、レビュー基準）
   - API仕様書（該当する場合）
...
**コンテキストを理解せずにレビューを開始しないでください。**
プロジェクトの規約や設計方針を理解していないレビューは、不適切な指摘や見逃しにつながります。
