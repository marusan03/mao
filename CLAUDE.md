...
| エージェント動作 | `docs/WORKFLOW.md` |
| tmux統合 | `docs/TMUX_ARCHITECTURE.md` |
...
| ファイル | 内容 |
|---------|------|
| `README.md` | プロジェクト概要 + Quick Start + Usage |
| `CLAUDE.md` | Claude Code向け開発ガイド（このファイル） |
| `CHANGELOG.md` | 変更履歴 |
...
| `docs/API.md` | API仕様 |
| `docs/CLAUDE_CODE_INTEGRATION.md` | Claude Code統合 |
| `docs/CTO_ARCHITECTURE.md` | CTO設計詳細 |
| `docs/CODE_QUALITY.md` | 品質基準 |
| `docs/CODING_STANDARDS.md` | コーディング規約 |
| `docs/DASHBOARD_SPECIFICATION.md` | ダッシュボード設計 |
| `docs/INTERACTIVE_MODE.md` | インタラクティブモード |
| `docs/REALTIME_LOGGING.md` | リアルタイムログ |
| `docs/SHELL_COMPLETION.md` | シェル補完 |
| `docs/TMUX_ARCHITECTURE.md` | tmux統合 |
| `docs/WORKTREE_ISOLATION.md` | Worktree分離 |
...
2. docs/CTO_ARCHITECTURE.md - CTO設計
3. mao/orchestrator/ ディレクトリのコード
```

#### 4. tmux統合の変更
```
1. docs/TMUX_ARCHITECTURE.md - tmux統合設計
